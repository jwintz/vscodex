...
export class CommandProvider {
    ...
    public make_header() {
        ...
        while (line_last.trim() == "" && line_last_offset + 1 < document.lineCount) line_last = document.lineAt(document.lineCount - ++line_last_offset).text;
        ...
        editor
            ...
            .then((success) => {
                if (should_insert_header) editor.selection = new vscode.Selection(destination, destination);
    ...
    public make_divider() {
        ...
        editor
            ...
            .then(() => {
                editor.selection = new vscode.Selection(new vscode.Position(x, y), new vscode.Position(x, y));
