            ...
            <div class="space-y-6 lg:space-y-10">
                <div class="flex gap-x-5">
                    ...
                    <div class="grow">
                        ...
                        <p class="mt-1 text-justify text-vscode-descriptionForeground">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce quis enim lectus. Sed accumsan cursus feugiat.</p>
                    </div>
                </div>
